...
import argparse, importlib.util, io, json, runpy, sys
...
def main() -> None:
    ...
    full_web=run_hook(prompt_hook, {"session_id":"validate-full","prompt":"Review Burp JWT login traffic and verify token boundary reuse risks"})
